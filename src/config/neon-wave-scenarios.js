...
export const NEON_WAVE_SCENARIOS = [
  ...
  { wave: 18, pool: LATE_LAB_MIX, spawnRate: 1.58, event: { type: "hazard_field", count: 26, kind: "gear_trap", color: "#f59e0b", radius: 46, life: 999, fullWave: true, minPlayerDistance: 260 } },
