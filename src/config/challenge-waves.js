...
export const CHALLENGE_WAVES = [
  ...
  },
  {
    ...
    groups: [
      ...
      { time: 999, enemies: [{ id: "lancer", count: 2, config: { speed: 200, hp: 1200, dashSpeed: 1000, scale: 1.5, attackCd: 0.5, recoverDuration: 0.2, windupDuration: 0.3, dashDuration: 0.5, immuneFreeze: true, immuneGravity: true } }] },
    ],
  },
  {
    wave: 3,
    type: "annihilation",
    groups: [
      { time: 0, enemies: [{ id: "tank", count: 1, config: { speed: 100, hp: 2000, bulletSpeed: 500, attackDist: 800, cd: 0.8, bulletCount: 3, immuneFreeze: true, immuneGravity: true } }] },
      { time: 10, enemies: [{ id: "lancer", count: 2, config: { speed: 200, hp: 500, dashSpeed: 1000, immuneFreeze: true, immuneGravity: true } }] },
      { time: 15, enemies: [{ id: "lancer", count: 3, config: { speed: 200, hp: 500, dashSpeed: 1000, immuneFreeze: true, immuneGravity: true } }] },
      { time: 20, enemies: [{ id: "lancer", count: 2, config: { speed: 200, hp: 500, dashSpeed: 1000, immuneFreeze: true, immuneGravity: true } }] },
      { time: 25, enemies: [{ id: "lancer", count: 1, config: { speed: 200, hp: 1200, dashSpeed: 1000, scale: 1.5, attackCd: 0.5, recoverDuration: 0.2, windupDuration: 0.3, dashDuration: 0.5, immuneFreeze: true, immuneGravity: true } }] },
    ],
  },
  {
    wave: 4,
    ...
    duration: 35,
    groups: [
      { time: 0, enemies: [{ id: "pyromancer", count: 3, config: { speed: 150, hp: 6000, bulletSpeed: 350, cd: 1.5, fireRange: 1000, immuneFreeze: true, immuneGravity: true } }] },
