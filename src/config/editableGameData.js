...
export const ITEM_DATA_DEFS = [
  ...
  { id: "shackles", icon: "⌁", name: "脚镣", basePrice: 20, singleQuality: true, desc: "移动速度 -12，攻击范围 +80。" },
  { id: "dodge_cloak", icon: "◒", name: "闪避斗篷", basePrice: 24, singleQuality: true, desc: "闪避率 +5%，最大生命值 -20。" },
  { id: "bait", icon: "※", name: "诱饵", basePrice: 16, singleQuality: true, desc: "下一波敌人数量 +50%。" },
  { id: "magnet", icon: "◎", name: "磁铁", basePrice: 18, singleQuality: true, desc: "金币和经验吸收范围 +32。" },
  { id: "speed_boots", icon: "»", name: "速度靴", basePrice: 20, singleQuality: true, desc: "移动速度 +18。" },
  { id: "rapid_cord", icon: "⟲", name: "速射索", basePrice: 28, singleQuality: true, desc: "攻击速度 +12%。" },
  { id: "fang", icon: "⋏", name: "尖牙", basePrice: 30, singleQuality: true, desc: "攻击附加 7 DPS 流血，持续 2.8 秒。" },
  { id: "split_shot", icon: "≋", name: "分裂弹", basePrice: 34, singleQuality: true, desc: "随机强化一个武器槽：按武器类型增加传递、数量、范围或宽度，该武器伤害 -20%。" },
  { id: "lucky_clover", icon: "♣", name: "幸运草", basePrice: 26, singleQuality: true, desc: "幸运值 +10，商店更容易出现高品质商品。" },
  { id: "gloves", icon: "▣", name: "拳套", basePrice: 24, singleQuality: true, desc: "暴击率 +7%。" },
  ...
  { id: "tardigrade", icon: "⬡", name: "水熊虫", basePrice: 30, singleQuality: true, desc: "每波免疫 1 次攻击伤害，可叠加次数。" },
  { id: "heavy_armor", icon: "▰", name: "重甲", basePrice: 28, singleQuality: true, desc: "防御 +8，移动速度 -10。" },
  { id: "turret", icon: "♜", name: "炮塔", basePrice: 38, singleQuality: true, desc: "每波在玩家当前位置附近部署 1 座自动炮塔。" },
  { id: "thief_mark", icon: "¢", name: "窃贼印记", basePrice: 24, singleQuality: true, unique: true, desc: "只能购买 1 个。敌人金币掉落 +20%，被攻击时损失当前金币 6%。" },
  { id: "star_cloak", icon: "✦", name: "星星斗篷", basePrice: 36, singleQuality: true, unique: true, desc: "只能购买 1 个。被攻击时召唤 8 颗星雨反击敌人。" },
  { id: "landmine", icon: "◈", name: "地雷", basePrice: 32, singleQuality: true, desc: "每波随机生成 3 个地雷，可叠加。" },
